function createEnding(engine, results) {
    ...
    const mansurPvs = results.popularVotes.get(mansurId);
    ...
    const mansurPercentage = mansurPvs / totalPvs;
    
    // ENDINGS WHEN PLAYER IS ERDOĞAN
    if (playerId === erdoganId) {
        if (mansurPercentage > 0.50) {
            return {
                slides: [
                    {
                        imageUrl: "https://yurtsever.org.tr/wp-content/uploads/2017/09/ERDOreferandum.jpg",
                        endingHeader: "The National Will Has Spoken",
                        endingText: "The television screens turn orange, then red. For the first time since 2002, the Adam (The Man) has fallen. Mansur Yavaş has crossed 50.1%, and the Supreme Election Council confirms the result. A heavy silence hangs over the Presidential Complex in Beştepe. Your advisors are whispering about 'irregularities' and 'appeals,' but the margin is too wide to bridge. You walk out onto the balcony one last time. The crowd is smaller, their faces nervous. You don't scream; you don't mock. You speak with the heavy, rhythmic tone of a man who knows he is entering the history books as a former leader. You have spent your life saying 'The National Will is supreme' and tonight, you are forced to prove you meant it. 'We came to power with the approval of our people, and if our people have changed their minds, we will do what democracy requires. We do not recognize any power above the National Will. Although we are saddened by this result, we will not be among those who disrespect the decision of the casket. We have served this nation for 21 years with love; we leave it with our heads held high.'"
                    }
                ]
            };
        }
        
        // Ending 1: Erdogan >40% and Mansur > Erdogan
        if (mansurPvs > 0.1 && mansurPercentage > erdoganPercentage) {
            engine.setNewMusic([
                {
                    displayName: "Saat Kaç",
                    imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_pbcAU9SR8RkHo7pHYm1bPX_aH1k7mDM5Dw&s",
                    url: "https://ia600102.us.archive.org/33/items/hdpnin-yasaklanan-secim-sarkisi-babacim-saat-kac/HDP%27nin%20yasaklanan%20se%C3%A7im%20%C5%9Fark%C4%B1s%C4%B1%20babac%C4%B1m%20saat%20ka%C3%A7.mp3",
                }
            ]);
            return {
                slides: [
                    {
                        imageUrl: "https://tele1comtr.teimg.com/crop/1280x720/tele1-com-tr/wp/uploads/2019/12/adasdasdasdasdasdasdasdasdasd.jpg",
                        endingHeader: "The Kingmaker's Prison Cell",
                        endingText: "It is 3:00 AM. The map of Turkey is a mosaic of three colors. The nationalist surge behind Mansur Yavaş has stripped you of your usual majority in the Anatolian heartland, but your base has held firm enough to keep you in the race. However, for the first time in your career, you are in second place. The math is brutal. Neither you nor Yavaş reached the 50% threshold. The man who holds the keys to the presidency is in a high-security cell in Edirne. Selahattin Demirtaş, despite being imprisoned, has commanded a massive block of voters who refuse to back neither you or Yavaş. 'We have completed the first round by the favor of our nation. Now, some are looking toward Edirne for instructions. I am saying it clearly: As long as we are in office, neither 'Selo' nor those who take orders from the mountain will be able to dictate the future of this country. This country is a ruled by the judiciary. We will comply with whatever the law says, not what bargain-seekers at a table say.'"
                    }
                ]
            };
        }
                ...
                slides: [
                    {
                        imageUrl: "https://tele1comtr.teimg.com/crop/1280x720/tele1-com-tr/wp/uploads/2019/12/adasdasdasdasdasdasdasdasdasd.jpg",
                        endingHeader: "The Kingmaker's Prison Cell",
                        endingText: "It is 3:00 AM. The map of Turkey is a mosaic of three colors. The nationalist surge behind Mansur Yavaş has stripped you of your usual majority in the Anatolian heartland, but your base has held firm enough to keep you in the race. You are leading the race, but it will be hard to gain more votes. Neither you nor Yavaş reached the 50% threshold. The man who holds the keys to the presidency is in a high-security cell in Edirne. Selahattin Demirtaş, despite being imprisoned, has commanded a massive block of voters who refuse to back neither you or Yavaş. 'We have completed the first round by the favor of our nation. Now, some are looking toward Edirne for instructions. I am saying it clearly: As long as we are in office, neither 'Selo' nor those who take orders from the mountain will be able to dictate the future of this country. This country is a ruled by the judiciary. We will comply with whatever the law says, not what bargain-seekers at a table say.'"
                    }
                ]
            };
        }
        ...
        if (erdoganPercentage > 0.50 && runningMateId === 33661) {
            return {
                slides: [
                    {
                        imageUrl: "https://i.redd.it/4mi0s7rpypka1.jpg",
                        endingHeader: "بداية قرن تركيا",
                        endingText: "واقفا على الشرفة الأسطورية لمقر حزب العدالة والتنمية، تنظر إلى حشد من مئات الآلاف في الأسفل. أنت لم تفز في انتخابات فحسب؛ بل هزمت معارضة موحدة، ونجوت من أزمة اقتصادية، وأثبت أن الإرادة الوطنية ما زالت راسخة في قبضتك. منتقدوك وصفوا إنفاقك بأنه رشاوى، لكن الليلة سماه الشعب عدالة. ومع ضمان أغلبية برلمانية ساحقة أيضا، اختفت الضوابط والتوازنات. لم تعد مجرد رئيس؛ بل أصبحت المهندس بلا منازع لقرن تركيا. الفائز الوحيد الليلة ليس أنا، بل تركيا! لقد أعطت أمتي الجواب اللازم لأولئك الذين يتلقون الأوامر من قنديل وبنسلفانيا. قالوا باي باي كمال، وقد أرسله الشعب إلى بيته. والآن نترك المشاحنات خلفنا. أمامنا عالم لنقوده وقرن لنبنيه"
                    }
                ]
            };
        }
        
        // Ending 5: Sinan Oğan wins more than 50%
        ...
        // Ending 6: Kilicdaroglu wins more than 50%
        ...
        // Ending 7: Erdogan won less than 50% but still more than Kilicdaroglu
        ...
        // Ending 8: Erdogan won less than 50%, less than Kilicdaroglu
        if (erdoganPercentage < 0.50 && erdoganPercentage < kilicdarogluPercentage) {
            return {
                slides: [
                    {
